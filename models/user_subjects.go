...
var UserSubjectTableColumns = struct {
	ID        string
	SubjectID string
	UserID    string
	CreatedAt string
	...
	ID:        "user_subjects.id",
	SubjectID: "user_subjects.subject_id",
	UserID:    "user_subjects.user_id",
	CreatedAt: "user_subjects.created_at",
	UpdatedAt: "user_subjects.updated_at",
	DeletedAt: "user_subjects.deleted_at",
}
...
var UserSubjectWhere = struct {
	...
	SubjectID: whereHelperint{field: "\"user_subjects\".\"subject_id\""},
	UserID:    whereHelperint{field: "\"user_subjects\".\"user_id\""},
...
type userSubjectR struct {
	Subject *Subject `boil:"Subject" json:"Subject" toml:"Subject" yaml:"Subject"`
...
var (
	...
	userSubjectColumnsWithoutDefault = []string{"subject_id", "user_id"}
	userSubjectColumnsWithDefault    = []string{"id", "created_at", "updated_at", "deleted_at"}
	userSubjectPrimaryKeyColumns     = []string{"id"}
	userSubjectGeneratedColumns      = []string{}
)

type (
	// UserSubjectSlice is an alias for a slice of pointers to UserSubject.
	// This should almost always be used instead of []UserSubject.
	UserSubjectSlice []*UserSubject
	// UserSubjectHook is the signature for custom UserSubject hook methods
	UserSubjectHook func(context.Context, boil.ContextExecutor, *UserSubject) error
...
var userSubjectAfterSelectHooks []UserSubjectHook

var userSubjectBeforeInsertHooks []UserSubjectHook
var userSubjectAfterInsertHooks []UserSubjectHook

var userSubjectBeforeUpdateHooks []UserSubjectHook
var userSubjectAfterUpdateHooks []UserSubjectHook

var userSubjectBeforeDeleteHooks []UserSubjectHook
var userSubjectAfterDeleteHooks []UserSubjectHook

var userSubjectBeforeUpsertHooks []UserSubjectHook
var userSubjectAfterUpsertHooks []UserSubjectHook

// doAfterSelectHooks executes all "after Select" hooks.
func (o *UserSubject) doAfterSelectHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range userSubjectAfterSelectHooks {
...
func (o *UserSubject) doBeforeInsertHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range userSubjectBeforeInsertHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *UserSubject) doAfterInsertHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range userSubjectAfterInsertHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *UserSubject) doBeforeUpdateHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range userSubjectBeforeUpdateHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *UserSubject) doAfterUpdateHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range userSubjectAfterUpdateHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *UserSubject) doBeforeDeleteHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range userSubjectBeforeDeleteHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *UserSubject) doAfterDeleteHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range userSubjectAfterDeleteHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *UserSubject) doBeforeUpsertHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range userSubjectBeforeUpsertHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *UserSubject) doAfterUpsertHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range userSubjectAfterUpsertHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
// AddUserSubjectHook registers your hook function for all future operations.
func AddUserSubjectHook(hookPoint boil.HookPoint, userSubjectHook UserSubjectHook) {
	switch hookPoint {
	case boil.AfterSelectHook:
		userSubjectAfterSelectHooks = append(userSubjectAfterSelectHooks, userSubjectHook)
	case boil.BeforeInsertHook:
		userSubjectBeforeInsertHooks = append(userSubjectBeforeInsertHooks, userSubjectHook)
	case boil.AfterInsertHook:
		userSubjectAfterInsertHooks = append(userSubjectAfterInsertHooks, userSubjectHook)
	case boil.BeforeUpdateHook:
		userSubjectBeforeUpdateHooks = append(userSubjectBeforeUpdateHooks, userSubjectHook)
	case boil.AfterUpdateHook:
		userSubjectAfterUpdateHooks = append(userSubjectAfterUpdateHooks, userSubjectHook)
	case boil.BeforeDeleteHook:
		userSubjectBeforeDeleteHooks = append(userSubjectBeforeDeleteHooks, userSubjectHook)
	case boil.AfterDeleteHook:
		userSubjectAfterDeleteHooks = append(userSubjectAfterDeleteHooks, userSubjectHook)
	case boil.BeforeUpsertHook:
		userSubjectBeforeUpsertHooks = append(userSubjectBeforeUpsertHooks, userSubjectHook)
	case boil.AfterUpsertHook:
		userSubjectAfterUpsertHooks = append(userSubjectAfterUpsertHooks, userSubjectHook)
	}
}
...
func FindUserSubject(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*UserSubject, error) {
	...
	if err = userSubjectObj.doAfterSelectHooks(ctx, exec); err != nil {
		return userSubjectObj, err
	}
...
func (o UserSubjectSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if len(userSubjectBeforeDeleteHooks) != 0 {
		for _, obj := range o {
	...
	if len(userSubjectAfterDeleteHooks) != 0 {
		for _, obj := range o {
