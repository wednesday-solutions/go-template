...
var (
	userAllColumns            = []string{"id", "first_name", "last_name", "username", "password", "email", "mobile", "phone", "address", "active", "last_login", "last_password_change", "token", "role_id", "created_at", "updated_at", "deleted_at"}
	userColumnsWithoutDefault = []string{"first_name", "last_name", "username", "password", "email", "mobile", "phone", "address", "active", "last_login", "last_password_change", "token", "role_id", "created_at", "updated_at", "deleted_at"}
...
func (o *User) UserSubjects(mods ...qm.QueryMod) userSubjectQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"user_subjects\".\"user_id\"=?", o.ID),
	)
...
func (userL) LoadUserSubjects(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(qm.From(`user_subjects`), qm.WhereIn(`user_subjects.user_id in ?`, args...))
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *User) AddUserSubjects(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*UserSubject) error {
	var err error
...
// Sets o.R.User's UserSubjects accordingly.
// Replaces o.R.UserSubjects with related.
// Sets related.R.User's UserSubjects accordingly.
func (o *User) SetUserSubjects(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*UserSubject) error {
	query := "update \"user_subjects\" set \"user_id\" = null where \"user_id\" = $1"
...
// Sets related.R.User.
func (o *User) RemoveUserSubjects(ctx context.Context, exec boil.ContextExecutor, related ...*UserSubject) error {
	var err error
	for _, rel := range related {
		queries.SetScanner(&rel.UserID, nil)
		if rel.R != nil {
