...
var (
	...
	userColumnsWithoutDefault = []string{"first_name", "last_name", "username", "password", "email", "mobile", "address", "active", "last_login", "last_password_change", "token", "role_id", "created_at", "deleted_at"}
	userColumnsWithDefault    = []string{"id", "updated_at"}
