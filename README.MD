...
This is a Golang starter kit. It is designed to help you kickstart your project, skipping the 'setting-up part' and jumping straight to writing business logic.


This is inspired by [Gorsk](https://github.com/ribice/goboiler).
...
| github.com/stretchr/testify         | https://github.com/stretchr/testify        | Other        |
| github.com/go-pg/migrations         | https://github.com/go-pg/migrations        | BSD 2-Clause |
| github.com/dizzyfool/genna          | https://github.com/dizzyfool/genna         | MIT          |
|-------------------------------------|--------------------------------------------|--------------|
```
...
12. Go-Pg - PostgreSQL Migrations
13. Dizzyfool-Genna - Generating Models from PostgreSQL  
...
1. To use go-boiler as a starting point of a real project whose package name is something like `github.com/author/project`, move the directory `$GOPATH/ github.com/wednesday-solution/go-boiler` to `$GOPATH/github.com/author/project`. We use [task](https://github.com/go-task/task) as a task runner. Run ``task relocate`` to rename the packages, e.g. ``task relocate TARGET=github.com/author/project``
...
1. Create the postgres table and generate the model using Genna inside `pkg/utl/model/car.go`. Add methods on the struct if you need them.
