...
2. Install the sqlboiler, sql-migrate and gqlgen using
```
...
3. To run all the migrations using the script setup-local.sh as follows `./setup-local.sh`.

4. Generate the graphql models using `gqlgen generate`
